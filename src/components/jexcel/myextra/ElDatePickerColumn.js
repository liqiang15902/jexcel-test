...
import MyJExcelDatePicker from './myJExcelDatePicker';
import {getChildByNodeName} from "@/utils/element";

export class ElDatePickerColumn extends EditorBase{
    ...
    generateEditElement(value, cell, vueComponentDefinition=null) {
        let comp = super.generateEditElement(value, cell, MyJExcelDatePicker)
