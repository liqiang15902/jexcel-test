...
import MyElImage from './myElImage';
import MyElImageRead from './myElImageRead'
import {getTokenBridgeUrl} from "@/utils/token-bridge";
import {whatIsIt} from "@/utils/what-is-it";

export class ElImageColumn extends EditorBase{
  ...
  generateEditElement(value, cell, vueComponentDefinition=null) {
    ...
    let comp = super.generateEditElement(value, cell, MyElImage)
  ...
  generateDisplayElement(value, cell, vueComponentDefinition=null) {
    ...
    console.log(value);
    return super.generateEditElement(value, cell, MyElImageRead)
  }
